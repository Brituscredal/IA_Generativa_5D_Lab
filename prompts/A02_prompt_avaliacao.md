# A02 — Prompt com avaliação (rubrica)
...
- Se faltar dado essencial, listar no máximo 3 perguntas objetivas.
- Saída em markdown.
...
3) Estrutura — bem organizado, passo a passo, ordem lógica, segue o A01.
...
- Entregar exatamente nas seções do A01:
...
- Preencher a tabela abaixo com notas de 0 a 2 e uma observação curta por item:
...
- Listar 2 a 3 melhorias objetivas (ex.: reduzir dúvidas, deixar passos mais acionáveis, melhorar analogia).
